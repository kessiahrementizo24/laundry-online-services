    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class=" " id="sidebar-wrapper">   
         ...
         <div class="list-group list-group-flush my-3">
                ...
                <a href="fabric" class="list-group-item list-group-item-action bg-transparent text-white fw-bold">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light py-4 px-4" style="background-image: url('/admin-css/img/bg.jpg');">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Fabric Conditioner</h2>
                </div>
                ...
                <div class="table">
                    <a href="{{ route('fabric.create')}}" class="btn btn-sm"><i class="fa fa-plus-square">   Add new FabCon</i></a>
                </div>
                <table class="table table-bordered mt-2 text-dark">
                    <thead class="table table-bordered border-dark">
                      <tr>
                        <th>Fabric Conditioner No.</th>
                        <th>Name</th>
                        <th>Image</th>
                        <th> </th>
                      </tr>
                    ...
                    <tbody class="table table-bordered border-dark">
                       ...
                       @foreach ($fabric as $data)
                           <tr>
                            ...
                            <td>{{$data->fabric_name ?? ''}}</td>
                             <td><img src="{{asset('image/fabric/'.$data->image)}}"  width="50" ><td>
                           
                                <a href="{{route('fabric.edit',$data->id)}}" class="btn btn-primary btn-sm text-dark"> 
                                  Update
                                </a>
                                <form method="POST" class="d-inline" action="{{route('fabric.destroy',$data->id)}}">
                                    @csrf
                                    @method('DELETE')
