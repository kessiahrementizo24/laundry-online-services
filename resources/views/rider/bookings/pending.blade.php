                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="{{$order->weight}}">
                                        <button class="btn btn-primary ml-2">Update</button>
                                    </div>
                                </td>
                                
                                <td class="d-flex">
                                    <button class="btn btn-primary mr-2" onclick="updateViewStatusModal({{$order}})" data-bs-toggle="modal" data-bs-target="#viewStatusModal">View Details</button>
                                    <button class="btn btn-primary mr-2 mx-1" onclick="updateData({{$order}})" data-bs-toggle="modal" data-bs-target="#editStatus">Proceed to Pick Up</button>
